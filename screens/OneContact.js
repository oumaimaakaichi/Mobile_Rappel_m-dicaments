...
export default function OneContact({ route, navigation }) {
    ...
    return (
        ...
        <SafeAreaView style={{ height:HEIGHT,}}>
          ...
          />
           <Text style={{color:'black' , fontWeight:'bold' , fontSize:19 , alignSelf:'center' ,marginTop:11 , marginBottom:45  }}>Informations de la Contact</Text>
           ...
           <View
                ...
                >
                  ...
                  <Text style={{fontSize: 19, fontWeight: 'bold', marginBottom: 20, textDecoration: 'underline'}}>Contact:</Text>

                  <View style={{
      
                      flexDirection: "row"
                    }}>
                            <Text style={{fontWeight:'bold' , marginStart:10 , fontSize: 16}}>Docteur: </Text>
                  <Text style={{fontSize: 16, fontWeight:'bold' , color:'blue'}}>{contact.nom_docteur} </Text>
                  <Text style={{fontSize: 16 , fontWeight:'bold' , color:'blue'}}>{contact.Prenom_docteur} </Text>
  ...
  <Text style={{ marginStart: 10, marginTop: 15 }}>
    Spécialité: <Text style={{ color: "red" }}>{contact.Specialite_docteur}</Text>
  </Text>
</View>
      ...
      flexDirection: "row"
                   ...
                   <Text  style={{ marginStart:10 , marginTop:15}}> <AntDesign name="mail" color="rgb(70, 143, 183)" size={19} style={styles.icon} /> &nbsp;&nbsp; &nbsp;&nbsp;Email   : {contact.email}</Text>
                  </View>
                  <View style={{
      ...
      flexDirection: "row"
                   ...
                   <Text  style={{ marginStart:10 , marginTop:15}}> <AntDesign name="phone" color="rgb(70, 143, 183)" size={22} style={styles.icon} /> &nbsp;&nbsp;&nbsp;&nbsp;Numéro du téléphone   : {contact.num_telephone}</Text>
                  </View>
                  <View style={{
      ...
      flexDirection: "row"
                   ...
                   <Text  style={{ marginStart:10 , marginTop:15}}> <AntDesign name="home" color="rgb(70, 143, 183)" size={22} style={styles.icon} />&nbsp;&nbsp; &nbsp;&nbsp;Adresse   : {contact.adresse_doc}</Text>
                  </View>
