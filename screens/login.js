    ...
    >
     ...
     <></>
      ...
      >
        ...
        {error && !data.email &&<Text style={{color:'red' ,marginLeft:10,fontSize:10 , fontWeight:'bold'}} > champ obligatoire *</Text>}
     ...
     <Feather name="lock" style={styles.icon} color={colors.text} size={20} />
        ...
        </View>{error && !data.password &&<Text style={{color:'red' ,marginLeft:10,fontSize:10 , fontWeight:'bold'}} > champ obligatoire *</Text>}
