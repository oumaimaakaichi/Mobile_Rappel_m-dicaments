...
const InscriC = ({ navigation }) => {
  ...
  <TouchableOpacity
        ...
        {error && !password &&<Text style={{color:'red' ,fontSize:10 , fontWeight:'bold'}} > champ obligatoire *</Text>}
        {error && password.length<6 &&<Text style={{color:'red' ,fontSize:10 , fontWeight:'bold'}} > Mot de passe doit contenir minimum 6 caractéres </Text>}
